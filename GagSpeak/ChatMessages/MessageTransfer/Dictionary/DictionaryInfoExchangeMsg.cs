...
public partial class MessageDictionary {
    public bool LookupInfoExchangeMsg(string textVal, ref int encodedMsgIndex) {
        // The request for information from another user in the whitelist [ ID == 36 ]
        ...
        // The sharing of information (part 1) [ ID == 37 ]
        ...
        // The sharing of information (part 2) [ ID == 38 ]
        ...
        // The sharing of information (part 3) [ ID == 39 ]
        ...
        // The sharing of information (part 4) [ ID == 40 ]
        if((textVal.Contains("was powered Vibrator") || textVal.Contains("was an unpowered Vibrator"))
