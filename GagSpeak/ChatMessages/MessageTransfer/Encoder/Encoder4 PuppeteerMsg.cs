...
public partial class MessageEncoder {
    ...
    public string EncodePuppeteerToggleOnlySitRequestOptiong(PlayerPayload playerPayload, string targetPlayer) {
    ...
    public string EncodePuppeteerToggleOnlyMotionRequestOptiong(PlayerPayload playerPayload, string targetPlayer) {
        return $"/tell {targetPlayer} "+
        $"*{playerPayload.PlayerName} from {playerPayload.World.Name} "+
    ...
    public string EncodePuppeteerToggleAllCommandsOptiong(PlayerPayload playerPayload, string targetPlayer) {
        return $"/tell {targetPlayer} "+
        $"*{playerPayload.PlayerName} from {playerPayload.World.Name} "+
