...
public class MovementManager
{
    ...
    public MovementManager(RestraintSetToggleEvent restraintSetToggleEvent, CharacterHandler characterHandler) {
    ...
    private void OnRestraintSetToggled(object sender, RestraintSetToggleEventArgs e) {
        ...
        if(e.ToggleType == RestraintSetToggleType.Enabled) {
            ...
            bool weightedDown = _characterHandler.playerChar._uniquePlayerPerms[assignerIdx]._weightyProperty[e.SetIndex];
