...
public class UserProfileWindow : Window, IDisposable
{
    ...
    public override void Draw() {
        ...
        try
        {
            ...
            if(whitelistPlayerData._yourStatusToThem == "None" || whitelistPlayerData._yourStatusToThem == "") {
            ...
            if(whitelistPlayerData._theirStatusToYou == "None" || whitelistPlayerData._theirStatusToYou == "") {
            ...
            if(whitelistPlayerData._yourStatusToThem != "None" && whitelistPlayerData._theirStatusToYou != "None") {
