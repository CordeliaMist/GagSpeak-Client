...
#region RestraintSetOverview
    ...
    private void OverviewButtons() {
        ...
        string lambdaText = _restraintSetManager._restraintSets[_restraintSetManager._selectedIdx]._enabled ? "ACTIVE" : "INACTIVE";
        ...
        if (ImGui.Button($"{lambdaText}", buttonWidth)) {
            ...
            // apply the associated mods and store the original proiorities
        if(ImGui.IsItemHovered()) {
            ImGui.SetTooltip("Toggle the state of the restraint Set..\n"+
                             "INACTIVE == The set is disabled\n"+
                             "ACTIVE == The set is enabled");
        };
